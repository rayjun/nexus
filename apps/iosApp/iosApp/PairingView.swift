...
struct PairingView: View {
    ...
    var body: some View {
            ...
            VStack(spacing: 24) {
                ...
                VStack(alignment: .leading, spacing: 6) {
                    ...
                    TextField("wss://relay.example.com/relay", text: $relayUrl)
                        ...
                        .overlay(RoundedRectangle(cornerRadius: 12, style: .continuous).stroke(NexusStyle.line, lineWidth: 0.5))
                }
                ...
                VStack(alignment: .leading, spacing: 6) {
                    ...
                    TextField("K7M2P9QX3F5B8TZ2", text: $code)
                        ...
                        .padding(12)
                        .background(NexusStyle.row, in: RoundedRectangle(cornerRadius: 12, style: .continuous))
                        .overlay(RoundedRectangle(cornerRadius: 12, style: .continuous).stroke(NexusStyle.blue.opacity(0.6), lineWidth: 1.5))
                }
                ...
                Button(action: { isShowingScanner = true }) {
                    ...
                    .frame(height: 44)
                    .background(NexusStyle.blue.opacity(0.08), in: RoundedRectangle(cornerRadius: 12, style: .continuous))
                }
                .buttonStyle(.plain)
        ...
        .background(NexusStyle.background.ignoresSafeArea())
        .onAppear {
            if relayUrl.isEmpty {
